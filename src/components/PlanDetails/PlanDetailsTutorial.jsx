...
const PlanDetailsTutorial = ({
    ...
    // Check if any video is available at all
    ...
    return (
        <div className="space-y-4">
            ...
            {showTutorial && (
                <div className="bg-white rounded-2xl shadow-xl border overflow-hidden transition-all">
                    {/* Category Selection */}
                            ...
                            {categories.map((cat) => (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        // Reset to desktop if switching categories
                                        setActiveTutorialTab(0);
                                    }}
                                    className={`flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-bold transition-all ${activeCategory === cat.id
...
export default PlanDetailsTutorial;
